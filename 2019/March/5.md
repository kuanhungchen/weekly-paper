...
### 簡介 Introduction ###
本篇研究的是人與物體之間的互動關係，即：<人，物體，動作>，並將所提出的模型在 V-COCO、HICO-DET 兩個 datasets 上做實驗。

### 方法 Method ###
<img src="./image/5-1.png" width="850" />
上圖為本篇的模型，主要是在 Faster R-CNN 上再加入一條 human-centric branch，用來預測人的動作，並進行物體位置的預測。
對於一個 <人，物體，動作>的 triplet，其分數為：
<img src="./image/5-2.png" width="850" />
#### Object Detection ####
...
<img src="./image/5-3.png" width="850" />
